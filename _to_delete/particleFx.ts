 ...
 * The system tracks the emitter's world position every tick, so the trail
 * keeps following as the emitter moves. The caller is responsible for
 * disposing the returned system.
 *
 * @param scene - The Three.js scene.
 ...
 * The system tracks the emitter's world position every tick, so the glow
 * keeps surrounding the emitter as it moves. The caller is responsible for
 * disposing the returned system.
 *
 * @param scene - The Three.js scene.
