...
const FOV = 50;
const PRESET = { azimuth: Math.PI, polar: 1.2, distance: 10, target: [0, 0.3, 0], maxDistance: null, minDistance: 9, ceilingY: 4.8 };
...
const radius = (a) => Math.max(PRESET.distance * mult(a), PRESET.minDistance);
