/**
 * Environment setup for the generated __GAME_DISPLAY_NAME__ minigame.
 *
...
export function setupTemplateEnvironment(scene: Scene, shellCamera: PerspectiveCamera): TemplateEnvironmentRig {
  ...
  floorMaterial.name = '__GAME_ID___floorMat';
  const floor = new Mesh(new PlaneGeometry(10.5, 8.5), floorMaterial);
  floor.name = '__GAME_ID___floor';
  ...
  backdropMaterial.name = '__GAME_ID___backdropMat';
  const backdrop = new Mesh(new PlaneGeometry(11.5, 5.8), backdropMaterial);
  backdrop.name = '__GAME_ID___backdrop';
  ...
  leftAccentMaterial.name = '__GAME_ID___leftAccentMat';
  const leftAccent = new Mesh(new BoxGeometry(0.45, 1.5, 0.45), leftAccentMaterial);
  leftAccent.name = '__GAME_ID___leftAccent';
  ...
  rightAccentMaterial.name = '__GAME_ID___rightAccentMat';
  const rightAccent = new Mesh(new BoxGeometry(0.35, 1.15, 0.35), rightAccentMaterial);
  rightAccent.name = '__GAME_ID___rightAccent';
