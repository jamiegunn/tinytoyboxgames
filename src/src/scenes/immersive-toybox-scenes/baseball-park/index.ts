/**
 * Baseball Park scene entrypoint.
 *
...
import { composeInfieldProps } from './factory/props/simple/infield';
import { composeBleacherProps } from './factory/props/simple/bleachers';
import { composeScoreboardProps } from './factory/props/simple/scoreboard';
import { composeBattingTeeProps } from './factory/props/interactive/battingTee';
import { composeLooseBallProps } from './factory/props/interactive/looseBalls';
  ...
  const result = createWorldScene(scene, canvas, nav, {
    ...
    buildContents: (sc: Scene, cvs: HTMLCanvasElement, cam: Camera, _keyLight, dispatcher: WorldTapDispatcher) => {
      ...
      const propComposers: Array<(composeContext: ComposeContext) => DisposeFn> = [
        composeInfieldProps,
        composeBleacherProps,
        composeScoreboardProps,
        composeBattingTeeProps,
        composeLooseBallProps,
      ];
