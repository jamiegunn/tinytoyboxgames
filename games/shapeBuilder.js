...
const PUZZLES = [
  { name: "House", slots: [
    ...
    { shape: "triangle", x: 0.5,  y: 0.28, size: 50 },
    { shape: "circle",   x: 0.25, y: 0.52, size: 22 },
  ]},
  { name: "Smiley", slots: [
    { shape: "circle",   x: 0.5,  y: 0.42, size: 40 },
    { shape: "circle",   x: 0.3,  y: 0.28, size: 18 },
    { shape: "circle",   x: 0.7,  y: 0.28, size: 18 },
    { shape: "heart",    x: 0.5,  y: 0.58, size: 18 },
  ]},
  { name: "Rocket", slots: [
    { shape: "square",   x: 0.5,  y: 0.42, size: 40 },
    { shape: "triangle", x: 0.5,  y: 0.24, size: 38 },
    { shape: "diamond",  x: 0.28, y: 0.55, size: 25 },
    { shape: "diamond",  x: 0.72, y: 0.55, size: 25 },
  ...
  { name: "Flower", slots: [
    ...
    { shape: "heart",    x: 0.5,  y: 0.22, size: 22 },
    { shape: "heart",    x: 0.3,  y: 0.32, size: 22 },
    { shape: "heart",    x: 0.7,  y: 0.32, size: 22 },
    { shape: "heart",    x: 0.33, y: 0.52, size: 22 },
    { shape: "heart",    x: 0.67, y: 0.52, size: 22 },
  ]},
  { name: "Butterfly", slots: [
    { shape: "circle",   x: 0.5,  y: 0.40, size: 16 },
    { shape: "heart",    x: 0.28, y: 0.30, size: 32 },
    { shape: "heart",    x: 0.72, y: 0.30, size: 32 },
    { shape: "diamond",  x: 0.28, y: 0.55, size: 25 },
    { shape: "diamond",  x: 0.72, y: 0.55, size: 25 },
  ]},
  { name: "Robot", slots: [
    { shape: "square",   x: 0.5,  y: 0.22, size: 30 },
    { shape: "square",   x: 0.5,  y: 0.48, size: 40 },
    { shape: "circle",   x: 0.38, y: 0.22, size: 10 },
    { shape: "circle",   x: 0.62, y: 0.22, size: 10 },
    { shape: "square",   x: 0.5,  y: 0.35, size: 12 },
    { shape: "diamond",  x: 0.25, y: 0.48, size: 18 },
    { shape: "diamond",  x: 0.75, y: 0.48, size: 18 },
  ]},
  { name: "Fish", slots: [
    { shape: "circle",   x: 0.52, y: 0.40, size: 40 },
    { shape: "triangle", x: 0.25, y: 0.40, size: 35 },
    { shape: "circle",   x: 0.65, y: 0.32, size: 12 },
    { shape: "triangle", x: 0.52, y: 0.22, size: 20 },
  ]},
  { name: "Castle", slots: [
    { shape: "square",   x: 0.5,  y: 0.50, size: 50 },
    { shape: "square",   x: 0.26, y: 0.32, size: 25 },
    { shape: "square",   x: 0.74, y: 0.32, size: 25 },
    { shape: "triangle", x: 0.26, y: 0.20, size: 24 },
    { shape: "triangle", x: 0.74, y: 0.20, size: 24 },
    { shape: "circle",   x: 0.5,  y: 0.60, size: 16 },
  ]},
  { name: "Star Ship", slots: [
    { shape: "star",     x: 0.5,  y: 0.22, size: 35 },
    { shape: "square",   x: 0.5,  y: 0.46, size: 35 },
    { shape: "triangle", x: 0.28, y: 0.56, size: 22 },
    { shape: "triangle", x: 0.72, y: 0.56, size: 22 },
    { shape: "circle",   x: 0.5,  y: 0.60, size: 14 },
    { shape: "diamond",  x: 0.5,  y: 0.34, size: 16 },
  ]},
]
